...
export const Itinerary = () => {
  const { trip, resetTrip } = useTripPlanner();
  ...
  // Merge planner context data with default fallback structure
  const itinerary = {
    ...DEFAULT_ITINERARY,
    destination: trip?.destination?.name
      ? {
          ...
          tagline: trip.destination.description || "God's Own Country",
    ...
    <div className="min-h-screen bg-bg text-text-main flex flex-col relative">
      ...
      <main className="flex-grow max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          {/* Right Column: AI Insights, Budget, Cost Split & Group */}
      ...
      {/* Modals */}
      <EditItineraryModal isOpen={isEditOpen} onClose={() => setIsEditOpen(false)} itinerary={itinerary} />
